...
The prompts and the data logs for these showcases were taken from the Google Cybersecurity Professional Certificate
...
The report can be viewed on the file under the name Security incident report. The data used for generating
this report can also be viewed under the name Traffic log.  
...
The report for this can be viewed under the name Security risk assessment report.  
...
You can view the report under the name Incident report NIST CSF.  
